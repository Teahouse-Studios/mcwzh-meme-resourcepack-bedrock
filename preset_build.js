...
const preset_args = [
    {
        'platform': 'bedrock', 'type': 'mcpack', 'compatible': false, 'modules': {
            'resource': ['all'], 'collection': []
        }
    },
    {
        'platform': 'bedrock', 'type': 'mcpack', 'compatible': false, 'modules': {
    ...
    {
        'platform': 'bedrock', 'type': 'mcpack', 'compatible': true, 'modules': {
            'resource': ['all'], 'collection': []
        }
    },
    {
    ...
    {
        'platform': 'bedrock', 'type': 'zip', 'compatible': false, 'modules': {
            'resource': ['all'], 'collection': []
        }
    },
    {
        'platform': 'bedrock', 'type': 'zip', 'compatible': true, 'modules': {
            'resource': [], 'collection': []
        }
    },
]
...
async function start() {
    ...
    const be = new BedrockPackBuilder(await beModules.moduleInfo(), resolve(__dirname, './meme_resourcepack'), {
